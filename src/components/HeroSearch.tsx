        ...
        <div className="max-w-4xl mx-auto">
          ...
          <form className="flex justify-center items-center space-x-2">
            <input
              ...
              className="w-full max-w-md p-3 border rounded-l-full shadow-sm focus:outline-none text-gray-700"
              value={query}
            ...
            <button className="bg-red-500 text-white px-6 py-3 rounded-r-full hover:bg-red-600 ">
              ...
              >
                ...
                <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0 1 11 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 0 0 1-1.969 5.617zm-2.006-.742A6.977 6.977 0 0 0 18 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 0 0 4.875-1.975l.15-.15z"></path>
              </svg>
              Search
            </button>
          </form>
