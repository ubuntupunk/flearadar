...
export default function Articles() {
  const articles = [
    ...
    { title: "Believe it or not but Saturday is an excellent time to shop bric-a-brac", categories: ["Saturday Market", "Lifestyle"], author: "Kathryn Murphy", date: "10 August 2020", time: "8 min", image: "https://www.muizenmesh.co.za/wp/web/flearadar/Greenmarket-Square_GettyImages-940753486.webp" },
    { title: "Have you noticed local car-boot and yard-sales?", categories: ["Carboot", "Lifestyle"], author: "Darrell Steward", date: "10 August 2020", time: "5 min", image: "https://www.muizenmesh.co.za/wp/web/flearadar/photo-1517101724602-c257fe568157.jpeg" },
  ];
